...
<head>
    ...
    <title>Tambah Data | PHP | CRUD</title>
</head>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            ...
            <div class="col-md-6 my-2 text-center link">
                ...
                <a href="https://www.facebook.com/maulana.ismail.5076" target="_blank"><i class="bi bi-facebook fs-3"></i></a>
                <a href="https://github.com/Maulana1301" target="_blank"><i class="bi bi-github fs-3"></i></a>
                <a href="https://www.instagram.com/maulana__48?igsh=MWxyMTBxZDBuNTJzYQ==" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href="https://x.com/maulana65155219?s=09" target="_blank"><i class="bi bi-twitter fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="https://www.instagram.com/maulana__48?igsh=MWxyMTBxZDBuNTJzYQ==" target="_blank" style="color: #fff;">MAULANA ISMAIL</a></p>
    </footer>
    <!-- Close Footer -->
